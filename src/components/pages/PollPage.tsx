...
const pollData: PollData[] = [
  {
    question: '저희 앱 사용 이전에도 랜덤박스를 구매해 본 적이 있으신가요? (ex. 의류 랜덤박스, 전자기기 랜덤박스, 게임 랜덤박스 등 온오프라인에서의 모든 랜덤박스)',
    options: ['네! 있어요', '아니요, 없어요'],
    answerType: ANSWER_TYPE.SINGLE_SELECT,
    nextQuestion: [1, 4]
  },
  {
    question: '그 때의 만족도가 어땠나요?',
  ...
  {
    question: '다음 중 구매하고 싶은 5000원 랜덤박스 구성을 순서대로 골라주세요. 단, 비싼 상품일수록 당첨될 확률은 낮습니다.',
    options: ['4900원 ~ 1만원 사이의 상품들로 구성된 박스', '4000원 ~ 2만원 사이의 상품들로 구성된 박스', '1000원 ~ 5만원 사이의 상품들로 구성된 박스', '100만원 가치의 상품과 4500원 내외의 상품으로 구성된 박스', '100만원 가치의 상품과 2000원 미만의 상품으로 구성된 박스'],
