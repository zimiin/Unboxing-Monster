        ...
        description={
          <View>
            ...
            <RegularText style={styles.text}>
              ...
              - 상품을 확정하면 확정 시에 입력하신 휴대폰 번호로 모바일쿠폰이 발송됩니다.{'\n'}
              - 상품 확정 시점 부터는 환불 불가합니다.{'\n'}
              - 모바일 쿠폰의 유효기간은 30일이며, 쿠폰의 유효기간 연장 및 환불 불가합니다.{'\n'}
              - 모바일쿠폰의 재판매는 엄격히 금지됩니다.{'\n'}
              - 상품 확정 24시간 후에도 쿠폰이 전달되지 않은 경우, 발신자번호를 스팸차단, 통신환경(해외 또는 지하/산간 등 통신 불가지역) 등의 사유로 쿠폰을 수신받지 못하셨을 수 있습니다. 
      ...
      <PolicyDescriptionItem
        ...
        description={
            <RegularText style={styles.text}>
              ...
              - 모바일 쿠폰은 문자 메시지로 전송되며, 24시간 내로 전송됩니다. {'\n'}
